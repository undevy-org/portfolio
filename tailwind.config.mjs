...
const config = {
  // CRITICAL: Enable class-based dark mode switching
  darkMode: 'class',
  ...
  theme: {
    extend: {
      colors: {
        ...
        'dark-hover': 'rgba(34, 197, 94, 0.1)',          // green-500 with 10% opacity
        ...
        'light-text-tertiary': '#9ca3af',                // gray-400 for tertiary text
        'light-text-command': '#b45309',                 // darker yellow for better contrast
        'light-border': '#10b981',                       // green for borders
        'light-border-darker': '#059669',                // green-600 for darker borders
      ...
      fontFamily: {
        mono: ['var(--font-mono)', '"IBM Plex Mono"', 'ui-monospace', 'SFMono-Regular', 
